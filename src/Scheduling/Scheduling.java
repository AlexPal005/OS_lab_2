package Scheduling;// This file contains the main() function for the Scheduling.Scheduling
...
public class Scheduling {
    ...
    private static String resultsFile = "src\\Files\\Summary-Results";
        ...
        try {
            ...
            while ((line = in.readLine()) != null) {
                ...
                if (line.startsWith("process")) {
                    ...
                    processVector.addElement(new sProcess(cputime, ioblocking, 0, 0, 0, arrivalTime, numberProcess));
                    numberProcess++;
                }
    ...
    public static void main(String[] args) {
        ...
        if (args.length != 1) {
            System.out.println("Usage: 'java Scheduling.Scheduling <INIT FILE>'");
            System.exit(-1);
        }

        File f = new File(args[0]);
        if (!(f.exists())) {
            System.out.println("Scheduling.Scheduling: error, file '" + f.getName() + "' does not exist.");
            System.exit(-1);
        }
        if (!(f.canRead())) {
            System.out.println("Scheduling.Scheduling: error, read of " + f.getName() + " failed.");
            System.exit(-1);
        }
        ...
        if (processVector.size() < processnum) {
            ...
            while (processVector.size() < processnum) {
                ...
                processVector.addElement(new sProcess(cputime, i * 100, 0, 0, 0, 0, numberProcess));
                numberProcess++;
                i++;
            }
        }
        ...
        try {
            ...
            out.println("Scheduling.Scheduling Type: " + result.schedulingType);
            out.println("Scheduling.Scheduling Name: " + result.schedulingName);
